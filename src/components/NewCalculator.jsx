...
<div className="max-w-4xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg bg-gradient-to-r from-white via-[#d3e2f7] to-[#aac6e3] ">
  ...
  {/* Loan EMI and Payment details */}
  <div className="bg-white p-8 rounded-xl shadow-lg sm:w-full">
  ...
  {/* Break-up of Total Payment - Hidden on mobile */}
  <div className="bg-white p-8 rounded-xl shadow-lg flex flex-col items-center hidden md:block" style={{ background: "linear-gradient(135deg, #E0F7FA, #BBDEFB)" }}>
