...
const DirectorMsg = () => {
  return (
    <div className="bg-gray-50 py-16 px-4">
      ...
      <div className="max-w-full mx-14 flex flex-col md:flex-row items-center md:items-start bg-white shadow-lg rounded-lg p-8">
        {/* Image Section */}
        ...
        <div className="md:w-2/3 w-full md:pl-2">
          {/* <div className="flex items-center mb-4">
            <div className="text-indigo-600 text-4xl pr-2">“</div>
          ...
          Dear Visitor,
<br></br>
We at Goal Corporation have entered a new and very exciting phase in our journe... one of taking Goal Corporation global. We have set ambitious goals for ourselves - of being a well-known brand in most countries. We are fortunate to have young, dynamic professionals, partnering with us to achieve this.
<br></br>
<br></br>
<p>We have always believed in quality - be it in our work, our service or our products. Each one embodies our underlying ethos: that no task is too small and that God is in the details. We realize that in today's scenario, when people are being bombarded with information and products, we need to stand out. It is through our belief in the quality and efficacy of our product that we stand confident and poised to take on the world!          </p>
</p>
