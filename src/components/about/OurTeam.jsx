...
const TeamMemberItem = ({ member }) => (
  <div className="bg-white shadow-2xl rounded-2xl p-4 h-[100%] transition-transform duration-400 ease-in-out hover:scale-[1.05] hover:shadow-2xl hover:bg-indigo-50 border-b-4 border-blue-700 ">
    <div>
      <img
        src={member.img}
        alt={member.name}
