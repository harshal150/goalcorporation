...
import homepage from '../../assets/loans/buissness.jpeg';
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-0 left-0  h-full flex flex-col justify-center items-left ml-36 text-white">
        <h1 className="text-4xl font-bold mb-4 text-left text-[#ff3030]">Transform your Property <br></br>into Capital with Our <br></br>Loan Against Property Option</h1>
